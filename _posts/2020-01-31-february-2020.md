...
layout: post
title: February 2020
subtitle: .. beating the instant gratificaiton monkey
...
The instant gratification monkey has been winning for a very very long time now. I've been failing to do things that don't have any explicit dealdines. The only deadline
is death. If you don't know what the instant gratification monkey is, watch this video and then come back to this [blog](https://www.youtube.com/watch?v=arj7oStGLkU).
...
7. [I write a post about how we have only 1500 good weekends in life and end up wasting a lot of subseqeuent weekends](https://gyani.net/blog/and-another-weekend-goes-by/)
...
10. [I claim I'll not dirnk Soda for an year. I give up in month 4](https://gyani.net/blog/3-months-in-singapore/)
11. [I want to release a prodcut, doesn't happen](https://gyani.net/blog/3-months-in-singapore/)
...
13. [I want to learn the Harmonica, can't play a chort](https://gyani.net/blog/3-months-in-singapore/)
...
17. [I want to learn Full Stack Dev. Same year as above. Still suck at frontend](https://gyani.net/blog/bring-it-on-2017/)
...
I was really really naive in 2017 it seems. I wanted to "Master Web Security", "Learn Full Stack Dev" and "Learn Funcitonal Programming", "Make a beautifl product" along with a bunch of non-programming goals.
...
and worth doing. Probably lots of my ideas have been medium level but have been incorrectly labelled "hard" or "easy". Yesterday I realized to counter this polarization, if I think something
...
There's a great book by Steven Pressfield called the "War of Art". He says the blocker behind every creative endeavour is a universal force called "Resistance". It gets stronger as you move closer to your goal. Anywho, let's look at a random weekend plan
...
One goal this year is to run a 1000 km. This can be broken up into months of 83.33km or days of 2.73 km at any pace. Sounds easy right? Try doing it. Consistency is hard. Motivation dies a quick death. I've only managed to do 23.80/83.33
in January.
...
1. Running : As said, I want to run 1000km over an year. Given I have only run 23.80 so far I currently need to run about 2.914 km per day. That means in February I need to run 84.56 km. How do I do this? I'll be doing 10 km on Saturdays and at least 5 km on Fridays. On
...
1. 1000kms running - Being tracked!
